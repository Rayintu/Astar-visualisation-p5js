...
declare namespace p5 {
    ...
    class Table {
         ...
         *   columns, much like in a traditional spreadsheet5.Table object. By depault, an empty row is
         f
         .
    ...
    class Vector {
         ...
         *   calling String(v) or v.toString(). This method
         ctors
         ...
         *   vector to another, or adds two independata fr
         ctors
         *   together. The version of the method that adds two
         *   vectors together is a static method and returns a
         *   p5.Vector, the others acts directly on the vector.
         ...
         *   subtracts one vector from another, or subata fr
        ...
        /**
         *   Subtracts x, y, and z components from a vector,
         *   subtracts one vector from another, or subf the
         ...
         *   version of this method creates a new p5.Vectoent ve
         ...
         *   of this method creates a new p5.Vector ent ve
         the
         ...
         *   and returns the result as a float (this itracts
         ly
         ...
         *   returns the result as a float (this istracts
         ...
         *   cross product between two vectors. Both ttracts
         tic
         ...
         *   points (considering a point as a vector objtracts
         *
         *   @param v1 the first p5.Vector
         *   @param v2 the second p5.Vector
         *   @return the distance
         ...
         *
         *   @param amt the amount of interpolatr
         ...
         *   array. This is only for temporary use. r

         aram [length] the length of the new vector
         *   (defaults to 1)
         ...
         *   angles
         *
         *   @param theta thewhile
         angle, in radians (zero is
         *   up)
    ...
    class Font {
         ...
         *   two or three separate variables, the ds simp
         om a
        ...
        /**
         *   Sets the x, y, and z component of the vector using
         *   two or three separate variables, the d simpl
         om a
         *   p5.Vector, or the values from a float array.
         *
        ...
        /**
         *   Adds x, y, and z components to a vector, adds one
         *   vector to another, or adds two independt
        ...
        /**
         *   Adds x, y, and z components to a vector, adds one
         *   vector to another, or adds two independhe sta
        ...
        /**
         *   Subtracts x, y, and z components from a vector,
         *   subtracts one vector from another, or subhe sta
        ...
        /**
         *   Subtracts x, y, and z components from a vector,
         *   subtracts one vector from another, or subect).
        ...
        /**
         *   Multiply the vector by a scalar. The static
         *   version of this method creates a new p5.Vectoect).
        ...
        /**
         *   Divide the vector by a scalar. The static version
         *   of this method creates a new p5.Vector zed p5
         ly
         *   the equation sqrt(xx + yy + z*z).)
         *
        ...
        /**
         *   Calculates the magnitude (length) of the vector
         *   and returns the result as a float (this i   @pa
         y the
         ...
         *   version of the method that computes the do @para
         *   product of two independent vectors is a static
         *   method. See the examples for more context.
         *
         *   @param x x component of the vector
        ...
        /**
         *   Calculates the dot product of two vectors. The
         *   version of the method that computes the do the a
         *   product of two independent vectors is a static
         *   method. See the examples for more context.
         *
        ...
        /**
         *   Calculates the dot product of two vectors. The
         *   version of the method that computes the do   @pa
         tic
         *   and non static methods return a new p5.Vector. See
         *   the examples for more context.
         *
        ...
        /**
         *   Calculates and returns a vector composed of the
         *   cross product between two vectors. Both t the x
         *
        ...
        /**
         *   Calculates the Euclidean distance between two
         *   points (considering a point as a vector objparam
         .Vector
         */
        normalize(): p5.Vector
         ...
         *
         *    *
         ram max the maximum magnitude for the vector
         *   @chainable
         */
         ...
         *
         *  ion; s
         m len the new length for this vector
         *   @chainable
         */
         ...
         *
         *If use
         ram angle the angle of rotation
         *   @chainable
         */
         ...
         *
         *   @param  @par
         , y, and z components of a p5.Vector
         ...
         *   Linear interpolate the vector to another vector
         *
         *   @param amt the amount of interpolat polar
         d in
    ...
    */
    ...
    class MediaElement {
         ...
         *   addition to the methods of p5.Element, it alsolement.
         *
         */
        ...
        /**
         *   Play an HTML5 mps an
         HTML5 media element (sets current time to
         *   zero).
         *
         */
    ...
    class File {
        ...
        /**
         *   File subtype (usua file:e file extension jpg, png,
         *   xml, etc.)
         *
         */
        subtype: lly
...
*
    ...
    *
        ...
        * Only
        ...
        path
        is
        required.However, audio
        * file
        formats(i.e.mp3, ogg, wav
        and
        m4a / aac
    )
        are
    ...
    *
        ...
        * /
        constructor(path
    :
        string | any[], successCallback ? : Function, errorCallback ? : Function, whileLoadingCallback ? : Function
    )
        ...
        loadSound(path
    :
        string | any[], successCallback ? : Function, errorCallback ? : Function, whileLoading ? : Function
    ):
        SoundFile
    ...
    :
         ...
         *   in seconds
         */
        play(startTime ? : number, rate ? : number, amp ? : number, cueStart ? : number, duration ? : number)
    :
        void
    ...
    :
        void
             ...
             *   seconds
             */
            loop(startTime ? : number, rate ? : number, amp ? : number, cueLoopStart ? : number, duration ? : number)
    :
        void
    ...
    :
        void
            ...
            setVolume(volume
    :
        number | object, rampTime ? : number, timeFromNow ? : number
    ):
        void
             ...
             *   seconds from now
             */
            pan(panValue ? : number, timeFromNow ? : number)
    :
        void
    ...
    :
        ...
        void
             ...
             */
            processPeaks(callback
    :
        Function, initThreshold ? : number, minThreshold ? : number, minPeaks ? : number
    ):
        any[]
    ...
    class Env {
        ...
        /**
         *   Time until envonce areaches decayLevel.
         *
         */
        decayTime: any

        /**
         *   Level aelope ecay. The envelope will sustain here
        ...
        /**
         cayLevvel at the end of the release.
         *
         */
        releaseLevel: any

        /**
         *   Reset the e*   Lee with a series of time/value
         *   pairs.
         *
         *   @param attackTime Time nvelop
    ...
    class AudioIn {
         ...
         *   of other AudioIn methods like getLevel().      *
    ...
    */
    ...
    class EQ extends p5.Effect {
         ...
         *   Equal  *   p5.Filter API, especially gain and freq. Bands are
    ...
    */
         ...
         *   objects. To modify any bands, use methods of the(src:
         object): void
         }
         class Panner3D {
    /**
    ...
    */
         ...
         *
         *   - <a title="w3 spec for Panning Mode
         /**
    ...
    */
    ...
    class Convolver extends p5.Effect {
         ...
         *   sound of real physical spaces through a process  ConvolverNode

         /**
         *   Create a p5.Convolver. Accepts a path to a
         *   soundfile that will be used to generate an impulseerNod:   *   in this Array. Toggle between them with the
    ...
    */
         ...
         *   .addImpulse method, they will be stored as Objec *   .
    ...
    class Phrase {
         ...
         *   i.e. a series of notes and rests. Phrases must b   *   function's requirements, these values may be
    ...
    class Part {
         ...
         *   Instantiate a part with steps and ck
         ...
         *   step of the phrase. Depending on the callbatatums. By
    ...
    class SoundLoop {
         ...
         *   each iteration of thelooplTimeMode: boolean
    ...
    */
    ...
    ?:
        ...
        /**
         *   how many w?: nuthe callback has been called so far
         *
         */
        iterations: number
    }
...
extends
    ...
    :
        Function, interval ? : number | string
    )
...
:
    ...
    void
         ...
         *   more more loops in synchronization or to starmpress
         ...
         *   timeFromNow seconds
         */
        syncedStart(otherLoop
:
    object, timeFromNow ? : number
):
    void

        /**
         *   Getters and Setters, setting any paramter will
         *   result in a change in the clock's frequency, tics compression on an audio input source.
         AudioNode

         /**
         *   Performs the same function as .connect, but also
         *   accepts optional parameters to set compressoessor:
...
default
    ...
    * /
    process(src
:
    object, attack ? : number, knee ? : number, ratio ? : number, threshold ? : number, release ? : number
):
    void
...
:
    ...
    void
         ...
         *   change in value
         */
        attack(attack ? : number, time ? : number)
:
    void
...
:
    void
         ...
         *   change in value
         */
        ratio(ratio ? : number, time ? : number)
:
    void
...
class MonoSynth {
     ...
     *   MonoSynth amp
     *
     *   @param vol desi*   .ted volume
     *    *   @param [rampTime]   *   ime to reach new voe enve
     ...
     *   This method schedules the calling of
     : numb
     riggerAttack and .triggerRelease.
     *
     ...
     *   Set values like a traditional  ADSR envelope .
     *
     *   @param attackTime Time (in seconds beforT
     lope
     *   reaches Attack Level
     *   @param [decayTime] Time (in seconds) before
     *   envelope reaches Decay/Sustain Level
...
class PolySynth {
     ...
     *   synthesis. The PolySynth class holds an array of      *   being played. New notes are added as keys on the
...
.
     ...
     *   have been played and which notes are curre [note
     ] midi note to play (ranging from 0 to
